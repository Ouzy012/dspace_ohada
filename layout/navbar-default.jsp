...
%>
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="25" src="<%= request.getContextPath() %>/image/logo-img.png" alt="DSpace logo" /></a>
       </div>
 ...
 %> --%>
	...
	<form method="get" action="<%= request.getContextPath() %>/simple-search" class="navbar-form navbar-right">
        ...
        <button type="submit" class="btn" style="background-color: #337ab7;">
